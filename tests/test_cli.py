...
class TestCLI:
    ...
    def test_cli_with_access_token(
        self, temp_photos_dir: Path, access_token: str
    ) -> None:
    ...
    def test_cli_upload_failure(self, temp_photos_dir: Path, access_token: str) -> None:
    ...
    def test_cli_access_token_from_env(
        self, temp_photos_dir: Path, access_token: str, monkeypatch
    ) -> None:
